...
var app = (function () {
    ...
    // (74:8) <Button           type="is-primary"           active:computing           on:click={() => (computing = !computing)}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 77, 10, 2118);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(74:8) <Button           type=\\\"is-primary\\\"           active:computing           on:click={() => (computing = !computing)}>",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = text("\n          seconds.");
    			add_location(strong, file$4, 88, 10, 2315);
    			add_location(p, file$4, 87, 8, 2301);
    		},
    		m: function mount(target, anchor) {
    ...
    // (106:10) <Button             type={clock ? 'is-warning' : 'is-light'}             on:click={() => {               clockStart = performance.now();               clock = !clock;               tickTock();             }}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 112, 12, 2984);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(106:10) <Button             type={clock ? 'is-warning' : 'is-light'}             on:click={() => {               clockStart = performance.now();               clock = !clock;               tickTock();             }}>",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 60, 4, 1573);
    			attr_dev(div0, "class", "control");
    			add_location(div0, file$4, 62, 6, 1680);
    			attr_dev(div1, "class", "control");
    			add_location(div1, file$4, 69, 6, 1844);
    			attr_dev(div2, "class", "control");
    			add_location(div2, file$4, 72, 6, 1962);
    			attr_dev(div3, "class", "field has-addons has-addons-left");
    			add_location(div3, file$4, 61, 4, 1627);
    			add_location(hr0, file$4, 83, 4, 2215);
    			attr_dev(div4, "class", "notification is-secondary");
    			add_location(div4, file$4, 85, 4, 2227);
    			add_location(hr1, file$4, 96, 4, 2503);
    			attr_dev(div5, "class", "column is-three-quarters");
    			add_location(div5, file$4, 99, 6, 2566);
    			attr_dev(div6, "class", "field");
    			add_location(div6, file$4, 104, 8, 2733);
    			attr_dev(div7, "class", "column is-one-quarter has-text-right");
    			add_location(div7, file$4, 103, 6, 2674);
    			attr_dev(div8, "class", "columns is-mobile is-vcentered");
    			add_location(div8, file$4, 98, 4, 2515);
    			attr_dev(div9, "class", "container is-fluid");
    			add_location(div9, file$4, 59, 2, 1536);
    			attr_dev(section, "class", "section");
    			add_location(section, file$4, 58, 0, 1508);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		if (!Worker) {
    			...
    			$$invalidate(12, worker = new Worker("./worker.js"));
    			...
    			worker.addEventListener("message", event => {
    				switch (event.data.cmd) {
    					...
    					case "getPrimes":
    						//
    						$$invalidate(5, primes = event.data.payload);
    						break;
    				}
    			});
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*computing, worker, to*/ 4162) {
    			 if (computing === true) {
    				const computeStart = performance.now();

    				// this does NOT block execution of the main thread
    				worker.postMessage({ cmd: "getPrimes", params: { to } });
