...
var app = (function () {
    ...
    /* node_modules/svelma/src/components/Button.svelte generated by Svelte v3.29.4 */
    ...
    /* node_modules/svelma/src/components/Input.svelte generated by Svelte v3.29.4 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$2, 156, 4, 3907);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input_1, file$2, 143, 4, 3622);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(small, file$2, 190, 4, 4664);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 140, 0, 3439);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const thousandsizer = (x) => {
      if (!x) return "";
      return x.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    };

    const niceTimeCode = (ms) => {
    ...
    /* src/timecode.svelte generated by Svelte v3.29.4 */
    const file$3 = "src/timecode.svelte";

    function create_fragment$3(ctx) {
    	let div;
    	let raw_value = niceTimeCode(/*elapsed*/ ctx[0]) + "";

    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "timecode svelte-ih0b87");
    			add_location(div, file$3, 13, 0, 212);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*elapsed*/ 1 && raw_value !== (raw_value = niceTimeCode(/*elapsed*/ ctx[0]) + "")) div.innerHTML = raw_value;		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Timecode", slots, []);
    	let { elapsed = 0 } = $$props;
    	const writable_props = ["elapsed"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Timecode> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ elapsed, niceTimeCode });
    ...
    class Timecode extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { elapsed: 0 });
    	...
    	get elapsed() {
    		throw new Error("<Timecode>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set elapsed(value) {
    		throw new Error("<Timecode>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    // (56:8) <Button           type="is-primary"           active:computing           on:click={() => (computing = !computing)}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text("\n          Compute");
    			attr_dev(span, "class", "fa fa-computer");
    			add_location(span, file$4, 59, 10, 1620);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(56:8) <Button           type=\\\"is-primary\\\"           active:computing           on:click={() => (computing = !computing)}>",
    		ctx
    	});
    ...
    // (69:6) {#if primes.length}
    function create_if_block$2(ctx) {
    	let p;
    	let strong;
    	let t0_value = thousandsizer(/*primes*/ ctx[5].length) + "";
    	let t0;
    	let t1;
    	let t2_value = Number(/*computeElapsed*/ ctx[4] / 1000).toFixed(10) + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = text("\n          seconds.");
    			add_location(strong, file$4, 70, 10, 1817);
    			add_location(p, file$4, 69, 8, 1803);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*primes*/ 32 && t0_value !== (t0_value = thousandsizer(/*primes*/ ctx[5].length) + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*computeElapsed*/ 16 && t2_value !== (t2_value = Number(/*computeElapsed*/ ctx[4] / 1000).toFixed(10) + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    ...
    // (88:10) <Button             type={clock ? 'is-warning' : 'is-light'}             on:click={() => {               clockStart = performance.now();               clock = !clock;               tickTock();             }}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			attr_dev(span, "class", "fa fa-clock");
    			add_location(span, file$4, 94, 12, 2486);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(88:10) <Button             type={clock ? 'is-warning' : 'is-light'}             on:click={() => {               clockStart = performance.now();               clock = !clock;               tickTock();             }}>",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	function input1_value_binding(value) {
    		/*input1_value_binding*/ ctx[8].call(null, value);
    	}
    	...
    	let if_block = /*primes*/ ctx[5].length && create_if_block$2(ctx);

    	function timecode_elapsed_binding(value) {
    		/*timecode_elapsed_binding*/ ctx[10].call(null, value);
    	}

    	let timecode_props = {};

    	if (/*clockElapsed*/ ctx[3] !== void 0) {
    		timecode_props.elapsed = /*clockElapsed*/ ctx[3];
    	}

    	timecode = new Timecode({ props: timecode_props, $$inline: true });
    	binding_callbacks.push(() => bind(timecode, "elapsed", timecode_elapsed_binding));

    	button1 = new Button({
    			props: {
    				type: /*clock*/ ctx[0] ? "is-warning" : "is-light",
    	...
    	const block = {
    		c: function create() {
    			...
    			div9 = element("div");
    			h1 = element("h1");
    			h1.textContent = "Main thread only";
    			t1 = space();
    			div3 = element("div");
    			div0 = element("div");
    			...
    			div8 = element("div");
    			div5 = element("div");
    			create_component(timecode.$$.fragment);
    			t8 = space();
    			div7 = element("div");
    			div6 = element("div");
    			create_component(button1.$$.fragment);
    			attr_dev(h1, "class", "title");
    			add_location(h1, file$4, 42, 4, 1085);
    			attr_dev(div0, "class", "control");
    			add_location(div0, file$4, 44, 6, 1182);
    			attr_dev(div1, "class", "control");
    			add_location(div1, file$4, 51, 6, 1346);
    			attr_dev(div2, "class", "control");
    			add_location(div2, file$4, 54, 6, 1464);
    			attr_dev(div3, "class", "field has-addons has-addons-left");
    			add_location(div3, file$4, 43, 4, 1129);
    			add_location(hr0, file$4, 65, 4, 1717);
    			attr_dev(div4, "class", "notification is-secondary");
    			add_location(div4, file$4, 67, 4, 1729);
    			add_location(hr1, file$4, 78, 4, 2005);
    			attr_dev(div5, "class", "column is-three-quarters");
    			add_location(div5, file$4, 81, 6, 2068);
    			attr_dev(div6, "class", "field");
    			add_location(div6, file$4, 86, 8, 2235);
    			attr_dev(div7, "class", "column is-one-quarter has-text-right");
    			add_location(div7, file$4, 85, 6, 2176);
    			attr_dev(div8, "class", "columns is-mobile is-vcentered");
    			add_location(div8, file$4, 80, 4, 2017);
    			attr_dev(div9, "class", "container is-fluid");
    			add_location(div9, file$4, 41, 2, 1048);
    			attr_dev(section, "class", "section");
    			add_location(section, file$4, 40, 0, 1020);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(timecode, div5, null);
    			append_dev(div8, t8);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_value && dirty & /*to*/ 64) {
    				updating_value = true;
    				input1_changes.value = /*to*/ ctx[6];
    			...
    			const timecode_changes = {};

    			if (!updating_elapsed && dirty & /*clockElapsed*/ 8) {
    				updating_elapsed = true;
    				timecode_changes.elapsed = /*clockElapsed*/ ctx[3];
    				add_flush_callback(() => updating_elapsed = false);
    			}

    			timecode.$set(timecode_changes);
    			const button1_changes = {};
    			if (dirty & /*clock*/ 1) button1_changes.type = /*clock*/ ctx[0] ? "is-warning" : "is-light";
    		...
    		i: function intro(local) {
    			...
    			transition_in(timecode.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(timecode.$$.fragment, local);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const tickTock = () => {
    		if (clock) {
    			setTimeout(
    				function () {
    					$$invalidate(3, clockElapsed = performance.now() - clockStart);
    					tickTock();
    				},
    				desiredFrameRate
    			);
    	...
    	const click_handler = () => $$invalidate(1, computing = !computing);

    	function timecode_elapsed_binding(value) {
    		clockElapsed = value;
    		$$invalidate(3, clockElapsed);
    	}

    	const click_handler_1 = () => {
    		$$invalidate(2, clockStart = performance.now());
    		$$invalidate(0, clock = !clock);
    		tickTock();
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("desiredFrameRate" in $$props) desiredFrameRate = $$props.desiredFrameRate;
    		if ("clock" in $$props) $$invalidate(0, clock = $$props.clock);
    		if ("computing" in $$props) $$invalidate(1, computing = $$props.computing);
    		if ("clockStart" in $$props) $$invalidate(2, clockStart = $$props.clockStart);
    		if ("clockElapsed" in $$props) $$invalidate(3, clockElapsed = $$props.clockElapsed);
    		if ("computeElapsed" in $$props) $$invalidate(4, computeElapsed = $$props.computeElapsed);
    		if ("primes" in $$props) $$invalidate(5, primes = $$props.primes);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*computing, to*/ 66) {
    			 if (computing === true) {
    				const computeStart = performance.now();

    				// this blocks execution main thread
    				// browser freezes until getPrimes returns
    				$$invalidate(5, primes = getPrimes(to));

    				// main thread continues execution
    				const computeStop = performance.now();

    				$$invalidate(4, computeElapsed = computeStop - computeStart); // microseconds
    				$$invalidate(1, computing = false);
    			}
    		}
    	};
